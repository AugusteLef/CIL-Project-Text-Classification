# Script for loading the first additional dataset. 
# The dataset that you should use with this script can be found here:
...
#GLOBAL VARIABLES
output_path_pos = "Data/train_pos_add1.txt"
output_path_neg = "Data/train_neg_add1.txt"
