# Script for loading the 2nd additional dataset. 
# The dataset is available here: https://www.kaggle.com/c/tweet-sentiment-extraction/data?select=train.csv
...
#GLOBAL VARIABLES
output_path_pos = "Data/train_pos_add2.txt"
output_path_neg = "Data/train_neg_add2.txt"
...
def create_datasets(data: pd.DataFrame):
    ...
    positive_tweet.to_csv(output_path_pos, header=None, index=None, sep=',', mode='a',)
    negative_tweet.to_csv(output_path_neg, header=None, index=None, sep=',', mode='a',)
