...
def main(args):
    ...
    #splitdataset 
    xtrain,xtest,ytrain,ytest = train_test_split(padded_ids, labels, test_size=0.01) #WARNING, 0.01 because we want to train the model on the full dataset
    ...
    model.module.save_pretrained(os.path.join(args.model_destination, "checkpoint_NONE"))
    #Training
    no_train = 0
